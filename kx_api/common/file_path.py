...
test_report_path = os.path.join(os.path.split(os.path.split(current_path)[0])[0],'test_result','test_report','test_report.html')

#日志存储的地址
test_log_path = os.path.join(os.path.split(os.path.split(current_path)[0])[0],'test_result','test_log','kx.log')
